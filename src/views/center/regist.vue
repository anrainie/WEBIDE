<template>
  <div class="container">
    ...
    <form name="registForm" class="form-regist" @submit.prevent="registUser()">
      ...
      <input type="username" id="username" name="username" class="form-control" placeholder="UserName" v-model="user.username" required autofocus>
      <label for="password" class="sr-only">Password</label>
      <input type="password" id="password" name="password" class="form-control" placeholder="Password" v-model="user.password" required>
      <label for="password_r" class="sr-only">Password</label>
      <input type="password" id="password_r" name="password_r" class="form-control" placeholder="Password" v-model="user.password_r" required>
