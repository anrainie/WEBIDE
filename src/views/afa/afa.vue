<template>
    <div>
        ...
        <div id="ide_workbench">
            <fastbar id="left_fast_bar" :items="views.left" :horizontal='verical'></fastbar>
        ...
        <fastbar id="bottom_fast_bar" :items="views.bottom" :horizontal='horizontal'></fastbar>
    </div>
</template>
<style>
...
//            window.WORKBENCHPAGE = this.$refs.ide_workbenchPage;
            window.__Workbench = this.$refs.workbench;

//            window.views = this.activeViews;
